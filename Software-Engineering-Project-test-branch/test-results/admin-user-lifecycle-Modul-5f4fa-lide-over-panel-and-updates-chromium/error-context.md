...
- Name: admin\user-lifecycle.spec.ts >> Module 2: Admin User Lifecycle [INT/E2E] >> TP-ADM-E2E-03: modifies user role from slide-over panel and updates
- Location: tests\e2e\admin\user-lifecycle.spec.ts:69:7
