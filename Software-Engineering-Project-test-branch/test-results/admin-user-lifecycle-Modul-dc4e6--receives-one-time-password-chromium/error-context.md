...
- Name: admin\user-lifecycle.spec.ts >> Module 2: Admin User Lifecycle [INT/E2E] >> TP-ADM-E2E-04: triggers password reset and receives one-time password
- Location: tests\e2e\admin\user-lifecycle.spec.ts:99:7
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    23 × locator resolved to <html lang="en-US">…</html>
