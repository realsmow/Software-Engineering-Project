...
- Name: admin\user-lifecycle.spec.ts >> Module 2: Admin User Lifecycle [INT/E2E] >> TP-ADM-E2E-02: creates a user and displays temporary password modal
- Location: tests\e2e\admin\user-lifecycle.spec.ts:34:7
