 ...
 */
export const itemSortKey = z.enum(['available', 'name', 'popular', 'creditWeight']);
 ...
 * exist.
 */
export const listItemsInput = paginationInput.omit({ sort: true, order: true }).extend({
...
export const listRoomsInput = paginationInput.omit({ sort: true, order: true }).extend({
